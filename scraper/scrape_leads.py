...
PROMPT = (
    "You qualify sales leads for GrowPlus (growplus.site), a Mangalore agency whose core "
    "offer is AI-based CINEMATIC AD VIDEOS for brands - film-quality product/brand ads "
    "generated with AI, faster and cheaper than a traditional shoot. Strong fits: visual, "
    "product-led brands (jewellery, food & beverage, real estate, clothing/silk/fashion, "
    ...
    "Other), and Instagram URL if linked. Then add lead_score (1-10, how much they need a "
    "cinematic ad video: visual product +3, invests in marketing/social +2, reachable "
    "contact +2, weak or missing video/imagery +1-3, Karnataka/South India +1) and "
    "pitch_angle (one sentence proposing a concrete cinematic AI ad concept for THIS "
    "brand, citing their actual products, e.g. slow-motion macro shots of their bridal "
    "gold collection with a festive storyline). "
